...
class tweetOauth extends tweetConnection {
	...
	private $_authorizationUrl = 'https://api.twitter.com/oauth/authorize'; // Login each time
	private $_authenticationUrl = 'https://api.twitter.com/oauth/authenticate'; // Keep logged in
	...
	private $_apiUrl = 'https://api.twitter.com';
...
//		$oauth['oauth_token'] = $this -> _getAccessToken();
...
//		return array('request' => $params, 'oauth' => $oauth);
		return array('request' => $encodedParams, 'oauth' => $oauth);
	}
