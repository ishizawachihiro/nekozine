      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <ul class="nav">
            ...
            <? if($this->twitteroauth->logged_in()){ ?>
            <li><a href="<?= base_url() ?>profile/logout/twitter"><button class="btn btn-danger">LOGOUT</button></a></li>
            <? }else{ ?>
            <li><a href="<?= base_url() ?>profile/login"><button class="btn btn-danger">LOGIN</button></a></li>
            <? } ?>
          </ul>
        </div>
      </div>
